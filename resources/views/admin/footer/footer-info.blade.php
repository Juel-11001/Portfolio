        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Power By</label>
                <div class="col-sm-12 col-md-7">
                  <input  type="text" name="power_by" class="form-control" value="{{@$info->power_by}}">
                </div>
              </div>
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Footer Info</label>
                <div class="col-sm-12 col-md-7">
