                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.portfolio-item.update',$portfolioItem->id) }}" method="post"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="website_url" class="form-control" value="{{$portfolioItem->website_url}}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                      <select class="form-control selectric" name="category_id">
                                        ...
                                        <option {{$portfolioItem->category_id == $category->id ? 'selected' : ''}} value="{{$category->id}}">{{$category->name}}</option>
                                        @endforeach
