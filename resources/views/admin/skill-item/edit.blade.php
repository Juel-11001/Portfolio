        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Skill Percent</label>
                <div class="col-sm-12 col-md-7">
                    <input  type="text" name="skill_percent" class="form-control" value="{{$skill->skill_percent}}">
                </div>
                </div>
                <div class="form-group row mb-4">
